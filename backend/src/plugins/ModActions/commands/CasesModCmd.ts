...
import { emptyEmbedValue, renderUserUsername, resolveMember, resolveUser, trimLines } from "../../../utils";
    ...
    createPaginatedMessage(
      ...
      async (page) => {
        ...
        const embed = {
          author: {
            name: title,
            icon_url: mod instanceof GuildMember || mod instanceof User ? mod.displayAvatarURL() : undefined,
          },
          fields: [
